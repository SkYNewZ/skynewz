...
- [SkYNewZ/speedtest-prometheus-exporter](https://github.com/SkYNewZ/speedtest-prometheus-exporter) - Speedtest Prometheus exporter made in Go (5 days ago)
...
- [tinode/chat](https://github.com/tinode/chat) ([v0.18.0-rc1](https://github.com/tinode/chat/releases/tag/v0.18.0-rc1), 6 days ago) - Instant messaging platform. Backend in Go. Clients: Swift iOS, Java Android, JS webapp, scriptable command line; chatbots
