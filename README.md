...
- [SkYNewZ/gitignore](https://github.com/SkYNewZ/gitignore) - Generate .gitignore from cli (6 months ago)

#### 🚀 Latest releases I've contributed to


- [ovh/terraform-provider-ovh](https://github.com/ovh/terraform-provider-ovh) ([v0.28.1](https://github.com/ovh/terraform-provider-ovh/releases/tag/v0.28.1), 4 weeks ago) - Terraform OVH provider
