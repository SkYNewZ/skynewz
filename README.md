...
- [SkYNewZ/gitignore](https://github.com/SkYNewZ/gitignore) - Generate .gitignore from cli (7 months ago)

#### 🚀 Latest releases I've contributed to


- [ovh/terraform-provider-ovh](https://github.com/ovh/terraform-provider-ovh) ([v0.29.0](https://github.com/ovh/terraform-provider-ovh/releases/tag/v0.29.0), 1 month ago) - Terraform OVH provider
